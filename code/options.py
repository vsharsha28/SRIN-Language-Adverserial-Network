...
parser.add_argument('--train_size_src', type=int, default=1000)   # use all
parser.add_argument('--train_size_tgt', type=int, default=1000)   # use all
parser.add_argument('--iterate', action='store_true')			# read through iterations

# sequences and vocab arguments
parser.add_argument('--max_seq_len', type=int, default=50)		# no truncate
...
parser.add_argument('--n_vecs', type=int, default=200)
...
parser.add_argument('--q_critic', type=int, default=5)
